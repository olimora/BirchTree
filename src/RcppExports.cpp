...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type rebuild_count_before_outlier_removal(rebuild_count_before_outlier_removalSEXP);
    rcpp_result_gen = Rcpp::wrap(buildTree(data, BF_B, BF_L, threshold_T, distance_metric, cluster_size_metric, memory_limit_MB, subcluster_limit, rebuild_size_factor, remove_outliers, rebuild_count_before_outlier_removal));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_BirchTree_buildTree", (DL_FUNC) &_BirchTree_buildTree, 11},
    {NULL, NULL, 0}
};
